...
# Removed GPU for now --gres=gpu:1                                                              # no. of gpus (use only one) REMOVE IF ONLY RUNNING MSA
...
python run_alphafold.py --fasta_paths /projects/ilfgrid/apps/AF_unmasked/examples/1MKF/1MKF.fasta --flagfile databases.flag --flagfile /projects/ilfgrid/apps/AF_unmasked/examples/1MKF/template_data/templates.flag --output_dir /projects/ilfgrid/apps/AF_unmasked/examples --cross_chain_templates --dropout --model_preset='multimer_v2' --separate_homomer_msas

examples/1MKF/run_AF.sh
