...
OUTDIR="$AF_UNMASKED_DIR/examples" #Neater if this is seperate to the
...
cd $AF_UNMASKED_DIR
python prepare_templates.py --target $FASTAFILE \
    --template $TEMPLATE --output_dir $OUTDIR --align
